...
**For a detailed explanation of how this clean/smudge filter pipeline works, including configuration, scripts, performance considerations, and platform integration challenges, see [Git Clean/Smudge Filters for ASTs](./docs/filters.md).**
